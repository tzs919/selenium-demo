# 基于pytest-selenium，适用RemoteServer和Grid
# pytest -v test_spittr_pytest_selenium_remote.py --driver Remote --capability browserName chrome
# pytest -v test_spittr_pytest_selenium_remote.py --driver Remote --capability browserName firefox
# pytest -v test_spittr_pytest_selenium_remote.py --driver Remote --selenium-host 192.168.1.109 --selenium-port 4444 --capability browserName firefox
...
def test_add_spittle(selenium):
    ...
    selenium.get("http://192.168.1.109:8080/spittr/login")
    time.sleep(1)
